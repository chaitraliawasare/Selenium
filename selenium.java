...
public class selenium {  
    ...
    // declaration and instantiation of objects/variables  
     ...
     driver.findElement(By.id("lastName")).sendKeys("Greem");
     driver.findElement(By.id("email")).sendKeys("Rachel@tcs.com");
     ...
     //Login Details
     driver.findElement(By.xpath("//*[@id=\"username\"]")).sendKeys("Rachel@tcs.com");
     driver.findElement(By.xpath("//*[@id=\"password\"]")).sendKeys("2000");
     driver.findElement(By.xpath("//*[@id=\"login-submit\"]")).click();
     driver.findElement(By.xpath("/html/body/div/a")).click();
     //Add Employee
     driver.findElement(By.xpath("//*[@id=\"firstName\"]")).sendKeys("Ross");
     driver.findElement(By.xpath("//*[@id=\"lastName\"]")).sendKeys("Geller");
     driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("Ross@tcs.com");
